...
package ryan.com.librarybase.qrcode.camera;
...
final class FlashlightManager {
    ...
    static {
        ...
        if (iHardwareService == null) {
            Log.v("This device does supports control of a flashlight");
        } else {
            Log.v("This device does not support control of a flashlight");
        }
    }
    ...
    private static Class<?> maybeForName(String name) {
        try {
            ...
            Log.w( "Unexpected error while finding class " + re.toString());
            re.printStackTrace();
            return null;
        }
    }
    ...
    private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
        try {
            ...
            Log.w("Unexpected error while finding method " + re.toString());
            re.printStackTrace();
            return null;
        }
    }
    ...
    private static Object invoke(Method method, Object instance, Object... args) {
        try {
            ...
            Log.w("Unexpected error while invoking " + e.toString());
            e.printStackTrace();
            return null;
            ...
            Log.w("Unexpected error while invoking " + re.toString());
            re.printStackTrace();
            return null;
        }
    }
