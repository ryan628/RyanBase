...
public class SQLiteDatabasePool implements Serializable {
    ...
    private SQLiteDatabase.DBUpdateListener mDBUpdateListener; // 升级时监听器
    ...
    public synchronized static SQLiteDatabasePool getInstance(
            Context context, SQLiteDatabase.DBParams params, Boolean isWrite) {
    ...
    public static SQLiteDatabasePool getInstance(Context context) {
        SQLiteDatabase.DBParams params = new SQLiteDatabase.DBParams();
    ...
    public static SQLiteDatabasePool getInstance(Context context,
        ...
        SQLiteDatabase.DBParams params = new SQLiteDatabase.DBParams(dbName, dbVersion);
     ...
     * @param isWrite 打开数据库如果是 isWrite为true,则磁盘满时抛出错误
     */
    public SQLiteDatabasePool(Context context, SQLiteDatabase.DBParams params,
                              Boolean isWrite) {
...
//			TALogger.i(TASQLiteDatabasePool.this, "数据库连接己创建 ......");
    ...
    private SQLiteDatabase newSQLiteDatabase() {
        ...
        // 创建一个数据库连接
        SQLiteDatabase sqliteDatabase = new SQLiteDatabase(context, params);
    ...
    public synchronized SQLiteDatabase getSQLiteDatabase() {
        ...
        SQLiteDatabase sqliteDatabase = getFreeSQLiteDatabase(); // 获得一个可用的数据库连接
    ...
    private SQLiteDatabase getFreeSQLiteDatabase() {
        // 从连接池中获得一个可用的数据库连接
        SQLiteDatabase sqLiteDatabase = findFreeSQLiteDatabase();
    ...
    private void closeSQLiteDatabase(SQLiteDatabase sqlLiteDatabase) {
    ...
    class PooledSQLiteDatabase {
        SQLiteDatabase sqliteDatabase = null;// 数据库连接
